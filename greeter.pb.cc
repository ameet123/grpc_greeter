...
namespace protobuf_greeter_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "greeter.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
HelloRequest::HelloRequest()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_greeter_2eproto::InitDefaultsHelloRequest();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* HelloRequest::descriptor() {
  ::protobuf_greeter_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_greeter_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata HelloRequest::GetMetadata() const {
  protobuf_greeter_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_greeter_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
HelloReply::HelloReply()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_greeter_2eproto::InitDefaultsHelloReply();
  }
  SharedCtor();
